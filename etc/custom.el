(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (evil git-gutter-fringe magit gitignore-mode yasnippet web-mode use-package tide swift-mode spaceline-all-the-icons rainbow-delimiters projectile popup paredit nlinum neotree mmm-mode markdown-mode helm-core haskell-mode exec-path-from-shell evil-vimish-fold doom-themes counsel company clojure-mode avy all-the-icons-ivy all-the-icons-dired aggressive-indent))))
(custom-set-faces
